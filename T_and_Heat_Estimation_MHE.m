...
% px = [min(R_Cycle_no):1:max(R_Cycle_no)];
...
figure
ax1=subplot(311);
plot(t11(1:292703)/3600,R_Current1(1:292703))
ylabel('Current')
% xlim([0 10])

ax2=subplot(312);
plot(t11(1:292703)/3600,R_Temper1(1:292703))
hold on
plot(t11(1:292703)/3600,X_estimate(1:292703,1))
ylabel('Temperature')
% xlim([0 10])

ax3=subplot(313);
plot(t11(1:292703)/3600,X_estimate(1:292703,2))
hold on;
plot(t11(1:292703)/3600, R_Res(1:292703).*R_Current1(1:292703).^2)
