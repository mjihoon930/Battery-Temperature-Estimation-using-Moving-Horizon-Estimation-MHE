...
figure
ax1=subplot(311);
plot(t11(1: 15998 )/3600,R_Current1(1: 15998 ))
ylabel('Current')
% xlim([0 10])

ax2=subplot(312);
plot(t11(1: 15998)/3600,R_Temper1(1: 15998 ))
hold on
plot(t11(1: 15998 )/3600,X_estimate(1: 15998 ,1))
ylabel('Temperature')
% xlim([0 10])

ax3=subplot(313);
plot(t11(1: 15998 )/3600,X_estimate(1: 15998 ,2))
hold on;
plot(t11(1: 15998 )/3600, R_Res(1: 15998 ).*R_Current1(1: 15998 ).^2)
